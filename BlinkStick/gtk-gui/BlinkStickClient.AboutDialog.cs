...
namespace BlinkStickClient
{
	public partial class AboutDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget BlinkStickClient.AboutDialog
			this.Name = "BlinkStickClient.AboutDialog";
			this.Title = global::Mono.Unix.Catalog.GetString ("About");
			this.WindowPosition = ((global::Gtk.WindowPosition)(1));
			this.Resizable = false;
			this.SkipPagerHint = true;
			this.SkipTaskbarHint = true;
			// Internal child BlinkStickClient.AboutDialog.VBox
			...
			w7.Expand = false;
			w7.Fill = false;
			// Internal child BlinkStickClient.AboutDialog.ActionArea
